...
fig2 <- ggplot(iris, aes(Sepal.Length, fill = Species)) + 
  geom_density(alpha = 0.7) + theme_useR() + 
  theme(legend.position = c(0.8, 0.9))+ scale_fill_OkabeIto()
...
cvd_grid(ggplot(iris, aes(Sepal.Length, fill = Species)) + 
  geom_density(alpha = 0.7) + theme_useR(base_size = 18) + 
  theme(legend.position = c(0.7, 0.8))+ scale_fill_OkabeIto() ) 
```
...
```{r}
fig2 <- ggplot(iris, aes(Sepal.Length, fill = Species)) + 
  geom_density(alpha = 0.7) + theme_bw(base_size = 18) + 
  theme(legend.position = c(0.7, 0.8), legend.margin = margin(), 
        legend.title = element_blank())+scale_fill_OkabeIto()
fig_grid2 <- cvd_grid(fig2)
```
<br>
.pull-left[ 
...
ggplot(iris, aes(Sepal.Length, fill = Species)) + 
  geom_density(alpha = 0.7) + theme_bw(base_size = 28) + 
  theme(legend.position = c(0.8, 0.9), legend.title = element_blank(),
        legend.margin = margin()) + scale_fill_OkabeIto()
```
]
